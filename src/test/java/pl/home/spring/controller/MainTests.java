...
public class MainTests {
	...
	public void testMainPage() throws Exception {
		...
		assertThat(entity.getBody()).contains("Strona o rowerach");
	...
	public void test404Page() throws Exception {
		...
		ResponseEntity<String> responseEntity = this.restTemplate.exchange("/uri-not-exist", HttpMethod.GET, requestEntity, String.class);
